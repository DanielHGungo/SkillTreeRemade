function bfsTypeTwo(e, my){
    ...
    if(e == "Attr3"){
        ...
        if(BtnObjSuprArray[my][e] == false){
            ...
            if(BtnObjSuprArray[my][`Attr4`] == false){
            MITOsuperArray[my][`Attr6`] = false;
            }
            else{ return "bfsTypeTwo complete"; }
        }
            return "bfsTypeTwo complete";
    }
    if(e == "Attr4"){
...
function bfsTypeThree(e, my){
    ...
    if(e == "Attr3"){
        ...
        if(BtnObjSuprArray[my][e] == false){
            MITOsuperArray[my][`Attr5`] = false;
            if(BtnObjSuprArray[my][`Attr2`] == false){
                MITOsuperArray[my][`Attr4`] = false;
            }
            return "bfsTypeThree complete";
        }
    ...
    return "INVALID bfsTypeThree Function CALL";
}

function AMCoffThree(e, my){
    if( e == "Attr8" || e == "Attr9"){
        return true;
    }
    if( e == "Attr1"){
        if( BtnObjSuprArray[my][`Attr3`] == false){
            return true;
        }
        else{ return false; }
    }
    ...
    if( e == "Attr3"){
        if( BtnObjSuprArray[my][`Attr5`] == true){ return false;}
        if( BtnObjSuprArray[my][`Attr4`] == false){ return true;}
        else{
            if(BtnObjSuprArray[my][`Attr2`] == true){ return true;}
            else{ return false;}
        }
    }
    if( e == "Attr4"){
    ...
    if( e == "Attr5"){
        if(BtnObjSuprArray[my][`Attr7`] == false){return true;}
        else{ return false;}
    }
    if( e == "Attr6"){
        if(BtnObjSuprArray[my][`Attr8`] == true){ return false;}
        if(BtnObjSuprArray[my][`Attr9`] == false){ return true;}
        else{
    ...
    if( e == "Attr7"){
        if(BtnObjSuprArray[my][`Attr9`] == false){ return true; }
            ...
            if(BtnObjSuprArray[my][`Attr6`] == true){ return true; }
            else{ return false; } 
        }
    }
}